...
-- Ejercicio 3
-- Obtener el promedio de cantidad de productos vendidos por
-- categoría (product_name, quantity_per_unit, unit_price, quantity, avgquantity)
...
-- Ejercicio 4
-- Selecciona el ID de lcliente, la fecha de la orden y la fecha más antigua
-- de la orden para cada cliente de la tabla 'Orders'.
select
    o.customer_id,
    o.order_date,
...
-- el id de categoría y el precio unitario máximo para cada categoría
...
-- Ejercicio 8
-- Obtener el ranking de los empleados más jóvenes
-- (ranking, nombre y apellido del empleado, fecha de nacimiento)
select
...
-- Ejercicio 15
-- Mostrar por cada producto de una orden, la cantidad vendida y
...
-- Ejercicio 16
-- Obtener un listado de ordenes mostrando el id de la orden, fecha de orden,
...
-- nombre del producto, precio unitario, precio del producto anterior,
...
-- Ejercicio 18
-- Obtener un listado que muestra el precio de un producto junto con el
-- precio del producto siguiente:
select
    p.product_name,
    p.unit_price,
...
-- Ejercicio 19
-- Obtener un listado que muestra el total de ventas por categoría de
-- producto junto con el total de ventas de la categoría siguiente
select
